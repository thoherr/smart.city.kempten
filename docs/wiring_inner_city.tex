...
\newcommand\multiplexer[4]{
 ...
 \draw [color=red] (#1.pin 1) -- ++(-1.5,0) node[vcc]{3V3};
 \draw [color=black] (#1.pin 2) -- ++(-1.5,0) node[ground]{};
...
\foreach \x in {1,...,3} {
 ...
 \draw [color=red] (-3.25+\x*1.5,-18) -- ++(-0.25,0) |- ( (-3.25+\x*1.5,-19);
 \draw (-2.75+\x*1.5,-18) -- ++(0.25,0) |- (-2.75+\x*1.5,-19.25);
 }

\draw [color=red] (-5.5,-19) node[vcc]{USB Power} to[R=1.5\si{\kilo\ohm}] ++(3,0) -- ++(4.5,0); 
\draw (-2.5, -19.25) -- ++(5.5,0) node[ground]{};
...
\draw [color=red] (P.pin 40) -- ++(1.5,0) node[vcc]{USB Power};
