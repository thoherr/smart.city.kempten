...
\foreach \column in {1,...,4} {
 ...
 \foreach \column in {1,...,3} {
  \foreach \light in {1,...,3} {
    ...
    \ifnum\light=1
      \ifodd\column
        \draw [color=red] (P.pin 29) -| (15.25+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=red] (P.pin 22) -| (15.25+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
      \draw [color=red] (15.25+\column*2.5-\light*0.25,-5-\light*.25) -- (15.25+\column*2.5-\light*0.25,-7-\light*1.5) -- (15.25+\column*2.5,-7-\light*1.5);
    \fi

    \ifnum\light=2
      \ifodd\column
        \draw [color=yellow] (P.pin 27) -| (15.25+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=yellow] (P.pin 24) -| (15.25+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
       \draw [color=yellow] (15.25+\column*2.5-\light*0.25,-5-\light*.25) -- (15.25+\column*2.5-\light*0.25,-7-\light*1.5) -- (15.25+\column*2.5,-7-\light*1.5);
    \fi

    \ifnum\light=3
      \ifodd\column
        \draw [color=green] (P.pin 26) -| (15.25+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=green] (P.pin 25) -| (15.25+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
       \draw [color=green] (15.25+\column*2.5-\light*0.25,-5-\light*.25) -- (15.25+\column*2.5-\light*0.25,-7-\light*1.5) -- (15.25+\column*2.5,-7-\light*1.5);
    \fi
    ...
    \else
      \newcommand\ground{23}
    \fi
    \draw (15.25+\column*2.5,-7-\light*1.5) to[empty led] (15.75+\column*2.5,-7-\light*1.5) -- ++(0.5,0) |- (P.pin \inteval\ground);
    }
}
