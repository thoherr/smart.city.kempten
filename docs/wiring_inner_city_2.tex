...
\foreach \column in {1,...,4} {
 ...
 \foreach \column in {1,...,3} {
  \foreach \light in {1,...,3} {
    ...
    \ifnum\light=1
      \ifodd\column
        \draw [color=red] (P.pin 29) to[R=390\si{\ohm}, font=\tiny] ++(1.5,0) -| (17.25+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=red] (P.pin 22) to[R=680\si{\ohm}, font=\tiny] ++(1.5,0) -| (17.25+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
    ...
    \ifnum\light=2
      \ifodd\column
        \draw [color=yellow] (P.pin 27) to[R=390\si{\ohm}, font=\tiny] ++(1.5,0) -| (17.25+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=yellow] (P.pin 24) to[R=680\si{\ohm}, font=\tiny] ++(4.5,0) -| (17.25+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
    ...
    \ifnum\light=3
      ...
      \else
        \draw [color=green] (P.pin 25) to[R=1.5\si{\kilo\ohm}, font=\tiny] ++(1.5,0) -| (17.25+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
