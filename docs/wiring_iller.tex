...
\foreach \column in {1,...,4} {
  \foreach \light in {1,...,3} {
    ...
    \ifnum\light=1
      \ifodd\column
        \draw [color=red] (P.pin 12) -| (8+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=red] (P.pin 19) -| (8+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
      \draw [color=red] (8+\column*2.5-\light*0.25,-5-\light*.25) -- (8+\column*2.5-\light*0.25,-7-\light*1.5) -- (8+\column*2.5,-7-\light*1.5);
    \fi

    \ifnum\light=2
      \ifodd\column
        \draw [color=yellow] (P.pin 14) -| (8+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=yellow] (P.pin 17) -| (8+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
       \draw [color=yellow] (8+\column*2.5-\light*0.25,-5-\light*.25) -- (8+\column*2.5-\light*0.25,-7-\light*1.5) -- (8+\column*2.5,-7-\light*1.5);
    \fi

    \ifnum\light=3
      \ifodd\column
        \draw [color=green] (P.pin 15) -| (8+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=green] (P.pin 16) -| (8+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
       \draw [color=green] (8+\column*2.5-\light*0.25,-5-\light*.25) -- (8+\column*2.5-\light*0.25,-7-\light*1.5) -- (8+\column*2.5,-7-\light*1.5);
    \fi
    ...
    \else
      \newcommand\ground{18}
    \fi
    \draw (8+\column*2.5,-7-\light*1.5) to[empty led] (8.5+\column*2.5,-7-\light*1.5) -- ++(0.5,0) |- (P.pin \inteval\ground);
    }
}
