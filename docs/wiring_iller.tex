...
\foreach \column in {1,...,4} {
  \foreach \light in {1,...,3} {
    ...
    \ifnum\light=1
      \ifodd\column
        \draw [color=red] (P.pin 12) -| (7+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=red] (P.pin 19) -| (7+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
    ...
    \ifnum\light=2
      \ifodd\column
        \draw [color=yellow] (P.pin 14) -| (7+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=yellow] (P.pin 17) -| (7+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
    ...
    \ifnum\light=3
      \ifodd\column
        \draw [color=green] (P.pin 15) -| (7+\column*2.5-\light*0.25,-5-\light*.25);
      \else
        \draw [color=green] (P.pin 16) -| (7+\column*2.5-\light*0.25,-5-\light*.25);
      \fi
