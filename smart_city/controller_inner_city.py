...
class ControllerInnerCity(ControllerBase):
    ...
    def __init__(self, **kwargs):
        ...
        p1 = ParkingSpace(self.multiplexer, 0, VL53L0X)
        p2 = ParkingSpace(self.multiplexer, 1, VL53L0X)
        p3 = ParkingSpace(self.multiplexer, 2, VL53L0X)
        p4 = ParkingSpace(self.multiplexer, 3, VL53L0X)
        p5 = ParkingSpace(self.multiplexer, 4, VL53L0X)
        p6 = ParkingSpace(self.multiplexer, 5, VL53L0X)
